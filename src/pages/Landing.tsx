  ...
  return <div className="min-h-screen bg-gradient-to-b from-background to-secondary/30">
       ...
       <div className="container mx-auto px-4 py-16 md:py-24">
         <div className="text-center max-w-3xl mx-auto">
           <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Анализ способностей</h1>
           <p className="text-xl text-muted-foreground mb-8">Профессиональный тест состояния личности, который поможет вам лучше понять себя и раскрыть ваш потенциал</p>
       ...
       <div className="bg-card py-16">
         <div className="container mx-auto px-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
             {['Эмоциональная стабильность', 'Уровень счастья и удовлетворённости', 'Способность к самоконтролю', 'Уверенность в себе', 'Уровень активности', 'Коммуникативные способности', 'Ответственность и надёжность', 'Объективность восприятия'].map((item, index) => <div key={index} className="flex items-center gap-3 p-3">
